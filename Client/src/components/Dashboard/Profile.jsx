  ...
  useEffect(() => {
    ...
    return (
        <div className="space-y-6 max-w-7xl mx-auto">
            ...
            {/* Top Banner */}
            <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-600 px-6 py-8 shadow-sm">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    <div className="flex items-center">
                        <div className="h-20 w-20 rounded-full bg-white/20 flex items-center justify-center overflow-hidden ring-2 ring-white/30">
                            {currentImage ? (
                                <img src={currentImage} alt="user avatar" className="h-full w-full object-cover" />
                            ) : (
                                <span className="text-2xl font-bold text-black">
                                    {userInfo?.address ? userInfo.address.slice(2, 4).toUpperCase() : "U"}
                                </span>
                            )}
                        </div>
                        <div className="ml-6">
                            ...
                            <p className="text-violet-100 mt-1 font-mono">{formatAddress(userInfo?.address)}</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className="inline-flex items-center px-4 py-2 text-sm font-medium rounded-md text-violet-100 bg-white/10 hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white/50"
                        >
                            <svg id="refresh-icon" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center">
                                ...
                                <div className="ml-3">
                                    ...
                                    <p className="text-sm font-mono text-slate-800">{formatAddress(userInfo?.address)}</p>
                                </div>
                            </div>
                            <div className="flex items-center">
                                <div className="flex-shrink-0">
                                ...
                                <div className="ml-3">
                                    ...
                                    <p className="text-sm text-slate-800">{formatDuration(userInfo?.reloginPeriod || 60)}</p>
                                </div>
                            </div>
                            {userInfo?.ensName && (
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-3">
                                        <p className="text-xs text-slate-500">ENS Name</p>
                                        <p className="text-sm text-slate-800">{userInfo.ensName}</p>
                                    </div>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-2xl font-semibold text-slate-900">{userInfo?.loginCount || 0}</p>
                                </div>
                            </div>
                        </div>
                        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-sm text-slate-800">{formatDate(userInfo?.lastLogin)}</p>
                                </div>
                            </div>
                        </div>
                        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
                        <div className="flex items-start justify-between">
                            <div className="flex-1">
                                <h3 className="text-base font-semibold text-slate-900 mb-2">Session Settings</h3>
                                <p className="text-sm text-slate-600 mb-4">Set how long your authentication session should last before requiring you to sign in again.</p>
                                <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                                    <div className="w-full sm:max-w-xs">
                                        <label htmlFor="relogin-period" className="sr-only">Relogin period in minutes</label>
                                        <div className="relative">
                                            <input
                                                ...
                                                className="block w-full pr-16 border-slate-300 rounded-md shadow-sm focus:ring-violet-500 focus:border-violet-500 sm:text-sm"
                                                placeholder="60"
                                            />
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {[
                                            ...
                                            <button
                                                ...
                                                className="px-2 py-1 text-xs border border-slate-300 rounded hover:bg-slate-50 focus:outline-none focus:ring-1 focus:ring-violet-500"
                                            >
                                                {preset.label}
                                            </button>
                                        ))}
